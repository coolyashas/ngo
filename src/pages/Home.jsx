...
import { successCallback } from "../service/OpenGivApi.js";
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Welcome to the homepage of OpenGiv, a hub for Users to collaborate with NGOs, Charities and more."
        />
