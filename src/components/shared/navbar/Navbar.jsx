...
import navbarbrand from "../../../assets/pictures/Navbar/opengiv2.png";
import { resetUserData, selectUser } from "../../../redux/slice/userSlice";
import { Logout } from "../../../service/OpenGivApi";
    ...
    <nav>
      <div className="navbar_parent">
        <Link className="navbar_brand" to={"/"}>
          <img src={navbarbrand} alt="OpenGiv-logo" className="nav_brand_img" />
        </Link>
